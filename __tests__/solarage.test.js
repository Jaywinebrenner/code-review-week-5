...
describe('Determines how many solar years one has left to live and returns amount of solar years already surpassing life expectancy if so', () => {
  ...
  test('should correctly return how many Mercury years one has left to live and return the amount of years already surpassing life exectancy', () => {
    let mercuryYearsLeft = new PlanetExpectancy(74, 20);
    expect(mercuryYearsLeft.AllLifeExpectancyMercury()).toEqual("Your age in Mercury years is " + 225 + " . Lookin' Good!");
  });
